...
module.exports.loginController = async (req,res)=>{
  ...
  if(result){
    ...
    res.send("your details are incorect")
  }
}
...
module.exports.profileController = async (req,res)=>{
 ...
 let user = await userModel.findOne({email:req.user.email}).populate({path:"hissab",match:{createdAt:{$gte:startDate,$lte:endDate}},options:{sort:{createdAt:byDate}}})
